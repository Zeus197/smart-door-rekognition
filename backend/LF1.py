...
def sendSMS(faceId, phone, otp):
    ...
    url = "https://smartdoor-asg2.s3.amazonaws.com/virtualdoor.html?faceId="+faceId
...
def sendEmail(url,fileName):
    visitorUrl = "http://smartdoor-asg2.s3-website-us-east-1.amazonaws.com/index.html?fileName="+fileName
